...
export default function EditUserDialog({ isOpen, onClose, user }: EditUserDialogProps) {
  ...
  const validateForm = () => {
    ...
    if (formData.phone_no.trim() && formData.phone_no.length !== 10) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Email Address * <span className="text-xs text-red-500 ">Must be unique</span>
              </label>
              <input
                type="email"
                id="email"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-3 py-2 pr-10 border rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400 dark:bg-gray-700 dark:text-white dark:border-gray-600 ${
