...
const Page = () => {
  ...
  const fetchData = async () => {
    setLoading(true)
    try {
      const applications = await apiService.getApplications('direct-heavy')
  ...
  const handlePrint = () => {
    ...
    let printContent = `
      ...
      <html>
      <head>
        <title>Direct-Heavy Applications</title>
        <style>
      ...
      <body>
        <div class="header">
          <h1>Direct-Heavy Applications</h1>
  ...
  return (
    <div className="container mx-auto py-6 px-4 max-w-7xl">
      <h1 className="text-2xl sm:text-3xl font-bold mb-4">Direct-Heavy Applications</h1>
