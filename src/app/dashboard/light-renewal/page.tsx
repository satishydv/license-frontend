...
const Page = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const res = await fetch(`${apiBase}/applications?license_type=light-license-renewal`)
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold mb-4">Light License / Renewal Applications</h1>
