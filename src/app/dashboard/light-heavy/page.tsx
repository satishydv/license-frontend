...
const Page = () => {
  ...
  const handlePrint = () => {
    ...
    let printContent = `
      ...
      <html>
      <head>
        <title>Light to Heavy Applications</title>
        <style>
      ...
      <body>
        <div class="header">
          <h1>Light to Heavy Applications</h1>
  ...
  return (
    <div className="container mx-auto py-6 px-4 max-w-7xl">
      <h1 className="text-2xl sm:text-3xl font-bold mb-4">Light to Heavy Applications</h1>
